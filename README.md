...
Donate link: [Donate Here](https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=7Q49VJQNRCQ8E&lc=FR&item_name=ArtyShow&item_number=wp%2dbetter%2demails&currency_code=EUR&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted)
...
Please feel free to contribute to this plugin by forking the repository and submitting a pull request to the Develop branch.
...
If you're using the default template provided with WP Better Emails, you should delete the plugin and reinstall it to make sure you have the latest template improvements.
...
The example above is taking sponsored links as an additional content but you can imagine anything like including latest posts, a quote of the day or whatever.
...
![Screenshot 1](../develop/img/screenshot-1.png?raw=true "Screenshot 1")

2. WP Better Emails settings screen with the default WP TinyMCE editor.

![Screenshot 2](../develop/img/screenshot-2.png?raw=true "Screenshot 2")

3. Editor in source mode using CodeMirror syntax highlighting.

![Screenshot 3](../develop/img/screenshot-3.png?raw=true "Screenshot 3")

4. Live preview your template in a thickbox.

![Screenshot 4](../develop/img/screenshot-4.png?raw=true "Screenshot 4")

5. Help tab with information about available tags.

![Screenshot 5](../develop/img/screenshot-5.png?raw=true "Screenshot 5")
